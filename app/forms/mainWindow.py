...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.itemMenu = QtWidgets.QMenu(self.menubar)
        self.itemMenu.setObjectName("itemMenu")
        self.menubar.addAction(self.itemMenu.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.create.setStatusTip("Создать новую диаграмму")
        ...
        self.export.setText(_translate("MainWindow", "Экспортиковать в PNG"))
        self.export.setShortcut(_translate("MainWindow", "Ctrl+E"))
        self.export.setStatusTip("Сохранение диаграммы как картинку в формате PNG")
        self.exit.setText(_translate("MainWindow", "Выход"))
        self.exit.setShortcut(_translate("MainWindow", "Ctrl+W"))
        ...
        self.itemMenu.setTitle(_translate("MainWindow", "Элементы"))
